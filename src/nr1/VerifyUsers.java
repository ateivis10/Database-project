...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String username) {
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        ArrayList<User> list = UserDao.getAllRecord(username);
        Iterator<User> itr = list.iterator();
        while(itr.hasNext()) {
            User userObj = itr.next();
            if (!userObj.getUsername().equals("admin")) {
                dtm.addRow(new Object[]{userObj.getName(),userObj.getUsername(),userObj.getMobile(),userObj.getStatus()});
            }
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(517, 104, -1, -1));
        ...
        getContentPane().add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(595, 101, 273, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 139, 935, -1));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("*click on Row to Change Status");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(619, 578, -1, -1));
